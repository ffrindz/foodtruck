"""
A command line program that prints out an alphabetically ordered list
of all food trucks (10 at a time) that are open at that moment.

This program uses The San Francisco Data API found at
...
while keep_paging:
    if request.ok:
        ...
        if user_input == "next":
            ...
            user_input = raw_input("I didn't get that. Where to? (next, prev, exit): ").lower()
